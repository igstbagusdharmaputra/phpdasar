<?php
  //Code ini hampir mirip dengan tambah.php
  require 'functions.php';
  // dalam melakukakn ubah kita memerlukan url id
  $id = $_GET["id"];
  //var_dump($id);

  //query data berdasarkan
  $mhs = query("SELECT * FROM mahasiswa WHERE id = $id ")[0]; //ketika kita memanggil function query maka kita langsung mengambil array ke [0]
  //untuk mengecek hasil query dari variable $mhs
  //var_dump($mhs[0]); atau var_dump($mhs[0]["nim"]);
